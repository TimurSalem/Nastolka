...
def start_main_game():
    global main_game_flag
    main_game_flag = True


def show_questions(answered):
    ...
    question_text = pixel_font_56.render(question, True, (255, 255, 255))

    place = question_text.get_rect(center=(960, 140))
    screen.blit(question_text, place)

    for i in range(3):
        main_game_sprites.add(load_sprite('question_sprite.png', coord=(640 * i, 300)))
        answ = list(answers.keys())[i]
        screen.blit(pixel_font_48.render(answ, True, (255, 255, 255)), (700 * i, 500))
...
main_game_sprites = pygame.sprite.Group()
main_game_sprites.add(load_sprite('carpet_blue.png', coord=(0, 0)))
main_game_sprites.add(load_sprite('table.png', coord=(25, 0)))
main_game_sprites.add(load_sprite('svitok_forest.png', coord=(400, 60)))
...
ready_button = Button('button_ready.png', 'button_ready.png', func=start_main_game, sprite_group=lobby_screen_sprites,
                      coord=(1440, 880))

buttons = [setting_button, play_button, exit_button, ready_button]
...
while running:
    ...
    if main_game_flag:
        main_game_sprites.draw(screen)
        answered = show_questions(answered)
    # create_roads(screen)

    print(main_game_flag)
